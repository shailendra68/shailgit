...
3. Open the "application/controllers/Products.php" file => navigate to the buy() function and change the $paypalID variable value with your PayPal business email.
